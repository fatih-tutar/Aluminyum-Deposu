    ...
    <div class="container-fluid">
    	...
    	<div class="div4">
    		...
    		<div class="row">
    			...
    			<div class="col-md-6" style="text-align:right;">
    				...
    				<?php if($user->type == '2'){ ?><a href="/teklifarsivi" target="_blank"><button class="btn btn-primary">Teklif Arşivi</button></a><?php } ?>
	    ...
	    <div class="div4">
	    	...
	    	<?php
	    		...
	    		$tekliflistesicek = $db->query("SELECT * FROM teklif_listesi WHERE silik = '0' ORDER BY teklifid DESC", PDO::FETCH_ASSOC);
				...
				?>
				    		...
				    		<div class="row" style="margin-top: 5px;">
				    			...
				    			<div class="col-md-1">
				    				...
				    				<button type="submit" name="arsivarti" class="btn btn-success w-100"><i class="fas fa-plus"></i> Arşiv</button>

				    			</div>

				    			<div class="col-md-1">
				    				
				    				<button type="submit" name="arsiveksi" class="btn btn-danger w-100"><i class="fas fa-times"></i> Arşiv</button>

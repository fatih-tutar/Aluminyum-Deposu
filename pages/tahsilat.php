				...
				?>
							...
							<div id="tekliflerdivi<?= $firmaid; ?>" style="display: none;">
								...
								<div class="row">
									...
									<div class="col-6"><a href="/teklif/<?= $firmaid; ?>" target="_blank"><button class="btn btn-primary btn-sm">Teklif Formuna Git</button></a></div>
						...
						?>
								...
								<?php 	if (!empty($tekliflistesi)) { ?>
									...
									<?php
											...
											<a href="/teklifformu/<?= $tformid; ?>" target="_blank"><button class="btn btn-warning" style="margin-top: 10px;">Teklif formuna gitmek için tıklayınız.</button></a>

...
if (!isLoggedIn()) {
    ...
    if (isset($_POST['urunsil'])) {
        ...
        if ($urun_adet != 0 || $urun_depo_adet != 0 || $urun_palet != 0) {
            ...
            header("Location:/product/{$categoryId}?u={$productId}&urunsilinemez");
            ...
            header("Location:/product/{$categoryId}?urunsilindi#{$productId}");
    ...
    if (isset($_POST['teklifkaydet'])) {
        ...
        $insert = $query->execute(array($turunid,$tekliffirma,$teklifadet,$teklifsatisfiyat,time(),'0',$user->company_id,'0'));
            ...
            header("Location:/product/{$categoryId}?u={$turunid}&c_id={$tekliffirma}&teklifeklendi#{$turunid}");
    ...
    if (isset($_POST['add_purchase_orders'])) {
        ...
        if(empty($preparedBy) || empty($contactPerson)) {
            ...
            header("Location:/product/{$categoryId}?u={$productId}&sipariseklendi#{$productId}");
            exit();
        }
    ...
    if (isset($_POST['sevkiyatkaydet'])) {
        ...
        if(empty($firma)){
            ...
            header("Location:/product/{$categoryId}?u={$urunId}&sevkiyateklendi#{$urunId}");
            exit();
        }
    }
    ...
    if (isset($_POST['guncellemeformu'])) {
        ...
        header("Location:/product/{$categoryId}?u={$productId}&guncellendi#{$productId}");
    ...
    if (isset($_POST['siparisalindi'])) {
        ...
        header("Location:/product/{$categoryId}?u={$productId}&siparisalindi#{$productId}");
    ...
    if (isset($_POST['add_inventory'])) {
        ...
        header("Location:/product/{$categoryId}?inventory_added");
    ...
    if (isset($_POST['update_inventory'])) {
        ...
        if($update) {
            header("Location:/product/{$categoryId}?inventory_updated");
            exit();
        }else{
    ...
    if (isset($_GET['sipariseklendi'])) {
        ...
        $error = '<br/><div class="alert alert-success" role="alert"><a href="/factory" target="m_blank">Siparişin başarıyla eklendi. Buraya tıklayarak yönetim sayfasından sipariş formlarına ulaşabilirsin.</a></div>';

    }

    if (isset($_GET['siparisalindi'])) {

        $error = '<br/><div class="alert alert-success" role="alert"><a href="/factory" target="m_blank">Sipariş alındı ve sipariş kaydı geçmiş siparişlere eklendi.</a></div>';
        ...
        <div class="d-block d-sm-none">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <a href="/category/<?= $ust_kategori_id; ?>" style="color: white;">
            ...
            <div class="row">
                ...
                <?php if(in_array('due_date', $activeColumns) && $urunterminsaniye < time()){ ?>
                    ...
                    <div class="col-md-2 col-8">
                        ...
                        <a id="<?= $productId; ?>" href="/stock-activity/<?= $productId; ?>" target="_blank"><b style="color: red;"><?= "<small>".$urunlistesira.".</small>".$urun_adi; ?></b></a>
                ...
                <?php }else{ ?>
                    ...
                    <div class="col-md-2 col-8">
                        ...
                        <a id="<?= $productId; ?>" href="/stock-activity/<?= $productId; ?>" target="_blank"><b><?= "<small>".$urunlistesira.".</small> ".$urun_adi; ?></b></a>
                        ...
                        if ( $tklfcek->rowCount() ){
                            ...
                            foreach( $tklfcek as $tklfrow ){
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-8"><a href="/client/<?= $tverilenfirmaid ?>"><?= $tekliflersiralamasi.". ".$tverilenfirmaadi; ?></a></div>

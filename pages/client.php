		...
		if($authUser->type == '0'){
            ...
            if($isProfile){
                ...
                if (isset($_POST['delete_offer'])) {
                    ...
                    header("Location:/client/".$clientId);
                    exit();
                }
                ...
                if (isset($_POST['update_client'])) {
                    ...
                    header("Location:/client#" . ($orderId - 2));
                    exit();
                }
                    ...
                    <?php if(!$isProfile){ ?>
                        ...
                        <nav aria-label="Page navigation example">
                            ...
                            for ($i=1; $i <= $sayfaSayisi; $i++) {
                                echo '<li class="page-item"><a class="page-link" href="/client?s='.$i.'">'.$i.'</a></li>';
                            } ?>
                          </ul>
                        </nav>
                    <?php }else{ ?>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            foreach ($offerForms as $offerForm):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/teklifformu/<?= $offerForm->tformid ?>" target="_blank">
                                            ...
                                            <tr>
                                                <td colspan="4" style="padding:3px 10px;">
                                                    ...
                                                    <div style="float:right;">
                                                        Siparişi Oluşturan : <a href="/profil/<?= $order->created_by ?>"><b><?= getUsername($order->created_by) ?></b></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php }

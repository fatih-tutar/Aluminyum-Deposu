	    					...
	    					<div class="col-md-2 col-6">
								...
								<div class="row">
									...
									<?php if($ozet == 0){ ?>
										...
										<a href="/gelengiden?ozet=1"><button class="btn btn-info w-100 btn-sm">Özet Göster</button></a>

									<?php }else{ ?>

										<a href="/gelengiden?ozet=0"><button class="btn btn-info w-100 btn-sm">Özeti Kapat</button></a>

									<?php } ?>
									</div>
									<div class="col-md-6 col-6">
										<a href="/movement-report" target="_blank"><button class="btn btn-secondary btn-sm w-100">Rapor</button></a>
									</div>
								</div>

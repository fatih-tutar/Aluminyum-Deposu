<?php 
	...
	if ($girdi != 1) {
		...
		if (isset($_POST['hesapla'])) {
			...
			header("Location:home.php?fiyat=".$toplam);
		...
		if (isset($_POST['levhahesapla'])) {
			...
			header("Location:home.php?mt=".$malzemetipi."&k=".$kalinlik."&e=".$en."&b=".$boy."&a=".$adet."&toplam=".$toplam);
		...
		if (isset($_POST['kosebenthesapla'])) {
			...
			header("Location:home.php?mt=".$malzemetipi."&a=".$a."&b=".$b."&e=".$etkalinligi."&boy=".$boy."&adet=".$adet."&toplam=".$toplam);
		...
		if (isset($_POST['cubukhesapla'])) {
			...
			header("Location:home.php?mt=".$malzemetipi."&c=".$cap."&u=".$uzunluk."&a=".$adet."&toplam=".$toplam);
		...
		if (isset($_POST['boruhesapla'])) {
			...
			header("Location:home.php?mt=".$malzemetipi."&iccap=".$iccap."&discap=".$discap."&e=".$etkalinligi."&boy=".$boy."&adet=".$adet."&toplam=".$toplam);
